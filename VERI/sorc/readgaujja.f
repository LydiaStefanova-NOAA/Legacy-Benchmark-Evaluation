...
c.. get number of cases...
       ...
       do ncn=ncns,ncne
        ...
        if((imth.ge.6).and.(imth.le.8)) then
     ...
     * isyr,ismth,isday,iscy,ieyr,iemth,ieday,iecy,factor,nlead,
...
c.... v is for verification..
       real gridv(idim,jdim),climv(idim,jdim),climvt(idim,jdim,nlead)

c.... u is for experiment
       real gridu(idim,jdim),climu(idim,jdim),climut(idim,jdim,nlead)
...
c*  n*24 cases (twice a month for n years), 6 spheres+boxes, 140 6hr leads
       real*4 rms(icases,6,140),sx1(icases,6,140),sy1(icases,6,140),
     *cv(icases,6,140)
       real*4 crms(icases,6,140),csx1(icases,6,140),csy1(icases,6,140),
     *ccv(icases,6,140)
...
c...  first get climos
     ...
     *               NDATA,KSKP,KPDS,KGDS,LBMS,CLIMU,IRET)
          ...
          if(lead.eq.10) 
     *    print *,iyr,imth,iday,lead,climv(230,95),climu(230,95)
...
c*undef 9.999E+20
     ...
     * //'.seasmean.verf.jja.bin',FORM="unformatted")
      write(12) climvt
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.seasmean.model.jja.bin',FORM="unformatted")
      write(12) climut
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.'//rname(1:NFILL(rname))//'.dieoff.daily.jja.txt')
      do lead=4,140,4
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.'//rname(1:NFILL(rname))//'.dieoff.6hrly.jja.txt')
       do lead=1,140
      call talley(rms,sx1,sy1,cv,lead,ihemi
     *,res1,res2,res3,res4,res5,icases)
      call talley(crms,csx1,csy1,ccv,lead,ihemi
...
729   format('jja wk1-5 boxnr, four ijboxcorners landocean ',6i8,2f6.1)
      write(6,728)
728   format(1h ,'##########################################')
...
735   format('JJA RAW average of 12',f7.1,'  aggregate of icases',f7.1)
736   format('JJA SEC average of 12',f7.1,'  aggregate of icases',f7.1)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk1.raw.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk1.sec.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk2.raw.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk2.sec.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk3.raw.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk3.sec.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk4.raw.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk4.sec.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk34.raw.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
C     open file to write
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.wk34.sec.jja.ac',FORM="unformatted")
C    write to file
      WRITE(12)(acloco)
C     close file
      CLOSE(12)
...
c
     ...
     *icases,gridm)
      real*4 save(idim,jdim,icases,115),cosl(jdim),gridm(idim,jdim)
      real*4 savever(idim,jdim,icases,115)
...
c     call ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,1,27)
...
c      write(idch)acloc
c      write(6,100)rms(1,40),sx(1,40),sy(1,40),acloc(1,40)
c     call ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,28,55)
...
c      write(idch)acloc
c      write(6,100)rms(1,40),sx(1,40),sy(1,40),acloc(1,40)
c     call ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,56,83)
...
c      write(idch)acloc
c      write(6,100)rms(1,40),sx(1,40),sy(1,40),acloc(1,40)
c     call ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,84,111)
...
c      write(idch)acloc
c      write(6,100)rms(1,40),sx(1,40),sy(1,40),acloc(1,40)   
c     call ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,56,111)
        CASE DEFAULT
          PRINT *,'Unknown week.'
      END SELECT
...
c
      subroutine ninoav(gridm,idim,jdim,sx,sy,cov,rms,cosl,l1,l2)
...
100    format(1h ,'nino-ocean-ave: ',2i5,5f10.2)
      return
      end
