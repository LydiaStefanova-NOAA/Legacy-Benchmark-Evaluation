...
c
     ...
     * //'.CPCRAIN.seasmean.verf.mam.bin',FORM="unformatted")
      write(12) climvt
      ...
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.CPCRAIN.seasmean.model.mam.bin',FORM="unformatted")
      write(12) climut
...
733   format(1h ,'mam landocean and boxnr ',2i7)
       write(12,732)
