...
c
     ...
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
     * //'.annualmean.model.bin',FORM="unformatted")
      write(12) climut
