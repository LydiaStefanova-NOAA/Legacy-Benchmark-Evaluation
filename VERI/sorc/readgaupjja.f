       ...
       CHARACTER*200 expname,varname,varplot
...
C
       call getenv("varplot",varplot)
       write(*,*) "varplot= ",varplot
C
...
c.. get number of cases...
     ...
     * expdir,clmexp,expname,varname,varplot,plotdatadir,maskfile,
...
c
       parameter(nbox=6)
       CHARACTER*200 expname,rname,pname,varname,varplot
       CHARACTER*200 cpcvdir,clmcpcv
       CHARACTER*200 expdir,clmexp,plotdatadir
       CHARACTER*200 maskfile
...
c
     ...
     * //'.CPCRAIN.seasmean.verf.jja.bin',FORM="unformatted")
      write(12) climvt
      ...
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.CPCRAIN.seasmean.model.jja.bin',FORM="unformatted")
      write(12) climut
...
733   format(1h ,'jja landocean and boxnr ',2i7)
       write(12,732)
...
C wk1
      ...
      print *,'wk1.raw.jja.ac'
      do j=44,69,2
       write(6,277)deg(j),(acloco(i,j),i=246,321,3)
      enddo
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
