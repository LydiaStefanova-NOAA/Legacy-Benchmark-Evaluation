...
c  end initial condition loop
      ...
      do lead=1,nfdys
      climvt(:,:,lead)=climvt(:,:,lead)*gridm(:,:)! gridm=0 over the
c   ocean and for bad points; gridm=1 over valid landpoints
      enddo
