...
c* 144 cases (twice a month for 6 years), 6 spheres+boxes, 140 6hr leads
      dimension rms(144,6,140),sx1(144,6,140),sy1(144,6,140),
     *cv(144,6,140)
      dimension crms(144,6,140),csx1(144,6,140),csy1(144,6,140),
     *ccv(144,6,140)

      real*4 save(idim,jdim,144,115)
      real*4 savesec(idim,jdim,144,115)
      real*4 savever(idim,jdim,144,115)
      real*4 acts(144),cacts(144),res(16),cres(16)
...
c       print *,iyr,imth,iday,ncy,iyrv,imthv,idayv,icyv,ifhr
c
          do k=1,200
           JPDS(k) = -1
          enddo
...
C wk1
      call loccor(save,savever,idim,jdim,17,1,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C     close file
      ...
      call loccor(savesec,savever,idim,jdim,18,1,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C wk2
      call loccor(save,savever,idim,jdim,17,2,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C     close file
      ...
      call loccor(savesec,savever,idim,jdim,18,2,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C wk3
      call loccor(save,savever,idim,jdim,17,3,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C     close file
      ...
      call loccor(savesec,savever,idim,jdim,18,3,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C wk4
      call loccor(save,savever,idim,jdim,17,4,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C     close file
      ...
      call loccor(savesec,savever,idim,jdim,18,4,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C wk4
      call loccor(save,savever,idim,jdim,17,34,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
...
C     close file
      ...
      call loccor(savesec,savever,idim,jdim,18,34,acloco)
C     open file to write
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.'//varname(1:NFILL(varname))
