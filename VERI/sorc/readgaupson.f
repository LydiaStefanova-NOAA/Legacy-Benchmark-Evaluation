...
c
     ...
     * //'.CPCRAIN.seasmean.verf.son.bin',FORM="unformatted")
      write(12) climvt
      ...
      OPEN(UNIT=12,FILE=plotdatadir(1:NFILL(plotdatadir))
     * //'/'//expname(1:NFILL(expname))
     * //'.CPCRAIN.seasmean.model.son.bin',FORM="unformatted")
      write(12) climut
...
733   format(1h ,'son landocean and boxnr ',2i7)
       write(12,732)
