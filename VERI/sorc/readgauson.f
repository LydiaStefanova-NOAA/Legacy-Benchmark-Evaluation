...
729   format('son wk1-5 boxnr, four ijboxcorners landocean ',6i8,2f6.1)
      write(6,728)
728   format(1h ,'##########################################')
...
735   format('SON RAW average of 12',f7.1,'  aggregate of icases',f7.1)
736   format('SON SEC average of 12',f7.1,'  aggregate of icases',f7.1)
