...
lats=-20
latn=20
pngfile='pratebias.indian.1.png'

lonw=240
lone=360
lats=-20
latn=20
pngfile='pratebias.epacific.1.png'

lonw=0
lone=360
lats=-60
latn=60
pngfile='pratebias.global.1.png'
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv1 Day10 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv1 Day20 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv1 Day30 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
