...
*'d maskout((day10m1-day10v),0.1-landsfc.5(z=1))*86400.'
'd (day10m1-day10v)*86400.'
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day10 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
'set clevs -4.5 -4 -3.5 -3 -2.5 -2 -1.5 -1 -0.5 0.5  1  1.5  2 2.5  3 3.5  4 4.5'
'set ccols   29 28   27 26   25 24   23 22   21   0 31   32 33  34 35  36 37  38 39'
*'d maskout((day20m1-day20v),0.1-landsfc.5(z=1))*86400.'
'd (day20m1-day20v)*86400.'
'run /gpfs/dell2/emc/verification/noscrub/emc.climpara/Suru/gscripts/dline.gs 'lonw' 0 'lone' 0'
'run /gpfs/dell2/emc/verification/noscrub/emc.climpara/Suru/gscripts/cbar.gs'
'set gxout stat'
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day20 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
'set clevs -4.5 -4 -3.5 -3 -2.5 -2 -1.5 -1 -0.5 0.5  1  1.5  2 2.5  3 3.5  4 4.5'
'set ccols   29 28   27 26   25 24   23 22   21   0 31   32 33  34 35  36 37  38 39'
*'d maskout((day30m1-day30v),0.1-landsfc.5(z=1))*86400.'
'd (day30m1-day30v)*86400.'
'run /gpfs/dell2/emc/verification/noscrub/emc.climpara/Suru/gscripts/dline.gs 'lonw' 0 'lone' 0'
'run /gpfs/dell2/emc/verification/noscrub/emc.climpara/Suru/gscripts/cbar.gs'
'set gxout stat'
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day30 PRATE Bias (mm/day) mean='mean', rmse='rmse
****************************************************************
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day10 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day20 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day30 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
