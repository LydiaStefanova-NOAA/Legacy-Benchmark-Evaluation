...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day10 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day20 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day30 z500 hPa Bias (gpm) mean='mean', rmse='rmse
****************************************************************
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day10 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day20 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day30 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
