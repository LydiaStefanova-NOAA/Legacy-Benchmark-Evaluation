...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day10 SST Bias (K) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day20 SST Bias (K) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day30 SST Bias (K) mean='mean', rmse='rmse
****************************************************************
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day10 SST Bias (K) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day20 SST Bias (K) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day30 SST Bias (K) mean='mean', rmse='rmse
*
