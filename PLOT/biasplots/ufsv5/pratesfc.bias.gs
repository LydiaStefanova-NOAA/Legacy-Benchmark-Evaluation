...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day10 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day20 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv5 Day30 PRATE Bias (mm/day) mean='mean', rmse='rmse
****************************************************************
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day10 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day20 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv4 Day30 PRATE Bias (mm/day) mean='mean', rmse='rmse
*
