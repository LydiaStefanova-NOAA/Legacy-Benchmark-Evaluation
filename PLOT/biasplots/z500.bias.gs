...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day10 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day20 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.3 Day30 z500 hPa Bias (gpm) mean='mean', rmse='rmse
****************************************************************
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day10 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day20 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv3.1 Day30 z500 hPa Bias (gpm) mean='mean', rmse='rmse
*
