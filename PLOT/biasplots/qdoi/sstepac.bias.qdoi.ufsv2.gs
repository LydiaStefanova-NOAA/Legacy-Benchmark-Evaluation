'reinit'
'open /climate/noscrub/emc.climpara/Suru/validation/UGCS_veri_pkg_out/VERI_OUT/TMPsfc.UFSv2.T126.2/UFSv2.TMPsfc.annualmean.model.ctl'
...
'open /climate/noscrub/emc.climpara/Suru/validation/UGCS_veri_pkg_out/VERI_OUT/TMPsfc.UFSv2.T126.2/UFSv2.TMPsfc.annualmean.verf.ctl'
...
lats=-20
latn=20
pngfile='sstbias.epacific.qdoi.ufsv2.png'
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv2 Day10 SST Bias (K) vs. QDOI mean='mean', rmse='rmse
*
...
word=subwrd(line,4)
rmse=digs(word,2)
'draw title UFSv1 Day10 SST Bias (K) vs. QDOI mean='mean', rmse='rmse
*
